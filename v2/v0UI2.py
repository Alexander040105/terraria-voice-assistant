...
class ChatBubble(QFrame):
    def __init__(self, text, is_ai=True, parent=None):
        ...
        if is_ai:
            self.setStyleSheet("background-color: #313244; border-radius: 12px; color: #cdd6f4; margin-right: 20px;")
            self.label.setStyleSheet("padding: 6px;")
        else:
            self.setStyleSheet("background-color: #89b4fa; border-radius: 12px; color: #1e1e2e; margin-left: 20px;")
            self.label.setStyleSheet("padding: 6px; font-weight: bold;")
    ...
    def __init__(self):
        ...
        self.container.setStyleSheet("""
            QWidget#MainContainer {
                background-color: rgba(17, 17, 27, 230);
                border-radius: 20px;
        ...
        self.header.setStyleSheet("color: #89b4fa; font-size: 16px; font-weight: bold; letter-spacing: 1px;")
